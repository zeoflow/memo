...
import com.zeoflow.memo.annotation.PreferenceRoomImpl;
...
public class InjectorGenerator
{
    ...
    private static final String PREFERENCE_PREFIX = "_Preference";
    private static final String COMPONENT_PREFIX = "_Storage";
